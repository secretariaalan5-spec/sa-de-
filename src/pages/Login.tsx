 ...
 * Premium login screen with animated particle background.
 */
      ...
      <div className="max-w-[420px] w-full px-4 animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="auth-card">
          ...
          <div className="space-y-6">
            <div className="flex flex-col gap-3">
              <p className="text-center text-[13px] font-semibold text-slate-400 uppercase tracking-widest">
                Acesso Seguro
              </p>
        ...
        <div className="mt-8 text-center">
          <p className="text-white/40 text-[10px] uppercase tracking-widest font-bold">
            © 2026 Saúde+ Tecnologia em Saúde
          </p>
        </div>
      </div>
    </AuthBackground>
